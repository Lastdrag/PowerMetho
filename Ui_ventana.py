...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Ejecutar.setGeometry(QtCore.QRect(140, 150, 93, 28))
        ...
        self.line_2.setGeometry(QtCore.QRect(410, 130, 311, 20))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.line_3 = QtWidgets.QFrame(self.centralwidget)
        self.line_3.setGeometry(QtCore.QRect(10, 30, 20, 111))
        self.line_3.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.line_4 = QtWidgets.QFrame(self.centralwidget)
        self.line_4.setGeometry(QtCore.QRect(280, 30, 20, 111))
        self.line_4.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.line_5 = QtWidgets.QFrame(self.centralwidget)
        self.line_5.setGeometry(QtCore.QRect(20, 20, 271, 20))
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.line_6 = QtWidgets.QFrame(self.centralwidget)
        self.line_6.setGeometry(QtCore.QRect(710, 20, 20, 121))
        self.line_6.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.line_7 = QtWidgets.QFrame(self.centralwidget)
        self.line_7.setGeometry(QtCore.QRect(400, 20, 20, 121))
        self.line_7.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.line_8 = QtWidgets.QFrame(self.centralwidget)
        self.line_8.setGeometry(QtCore.QRect(410, 10, 311, 20))
        self.line_8.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_8.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_8.setObjectName("line_8")
        self.Ejecutar_2 = QtWidgets.QPushButton(self.centralwidget)
        self.Ejecutar_2.setGeometry(QtCore.QRect(300, 110, 93, 28))
        self.Ejecutar_2.setObjectName("Ejecutar_2")
        self.Ejecutar_4 = QtWidgets.QPushButton(self.centralwidget)
        self.Ejecutar_4.setGeometry(QtCore.QRect(600, 100, 93, 28))
        self.Ejecutar_4.setObjectName("Ejecutar_4")
        self.Ejecutar_5 = QtWidgets.QPushButton(self.centralwidget)
        self.Ejecutar_5.setGeometry(QtCore.QRect(650, 30, 51, 21))
        self.Ejecutar_5.setObjectName("Ejecutar_5")
        ...
        self.menuPowemetho = QtWidgets.QMenu(self.menuBar)
        self.menuPowemetho.setObjectName("menuPowemetho")
        MainWindow.setMenuBar(self.menuBar)
        self.menuBar.addAction(self.menuPowemetho.menuAction())

        self.retranslateUi(MainWindow)
        self.Ejecutar_2.clicked.connect(self.NumeroDeinteracciones.clear)
        self.Ejecutar_5.clicked.connect(self.TamanoMatriz.clear)
        self.Ejecutar_4.clicked.connect(self.MuestraNombreDoc.clear)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Ejecutar_2.setText(_translate("MainWindow", "Limpiar"))
        self.Ejecutar_4.setText(_translate("MainWindow", "Limpiar"))
        self.Ejecutar_5.setText(_translate("MainWindow", "Limpiar"))
        self.menuPowemetho.setTitle(_translate("MainWindow", "Powemetho"))
